...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-longctx-prolong-512k-instruct) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-longctx-prolong-512k-instruct` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-longctx-prolong-512k-instruct --local-dir lumynax-longctx-prolong-512k-instruct
cd lumynax-longctx-prolong-512k-instruct && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-longctx-prolong-512k-instruct -i
```
